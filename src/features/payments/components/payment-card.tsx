...
const getStatusConfig = (colors: Colors) => ({
  paid: {
...
export function PaymentCard({ payment }: PaymentCardProps) {
  ...
  const config = getStatusConfig(colors)[payment.status];
    ...
    <Card padding="xl" style={styles.card}>
        <View style={styles.header}>
          <View style={styles.monthContainer}>
            <Text variant="xs" color={colors.textSecondary} style={styles.monthLabel}>
              MES
            </Text>
            <Text variant="lg" weight="bold" color={colors.textPrimary}>
        ...
        <View style={styles.body}>
          <View style={styles.amountRow}>
            <Text variant="xs" color={colors.textSecondary} style={styles.amountLabel}>
              MONTO
            </Text>
        ...
        <View style={styles.footer}>
          ...
          {payment.status === 'paid' && (
            <View style={styles.footerStatus}>
              ...
              <Text variant="xs" color={colors.success} weight="medium">
                Pago confirmado
              </Text>
            </View>
          )}
          ...
          {payment.status === 'overdue' && (
            <View style={styles.footerStatus}>
              ...
              <Text variant="xs" color={colors.error} weight="medium">
                Requiere atención
              </Text>
            </View>
          )}
